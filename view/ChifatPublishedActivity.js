    ...
    render() {
        ...
        return (
            <ScrollView>
                ...
                <View>
                    <Text style={{ width: '90%', height: 67, alignSelf: 'center', fontFamily: 'NotoSansHans-Light', fontSize: 28, lineHeight: 67, fontWeight: 'bold' }}>{I18n.t('ChifatActivity.papers')}</Text>
                </View>
