...
//         <Text style={{ fontFamily: 'fantasy', lineHeight: 21, }}>
...
//         <Text style={{ fontFamily: 'fantasy', lineHeight: 21,marginBottom:18 }}>2011-- <Text style={{ fontWeight: '700', fontStyle: 'italic', fontFamily: 'fantasy' }}>{I18n.t('DavidActivity.fellow')}</Text>{I18n.t('DavidActivity.israel')}</Text>
//         <Text style={{ fontFamily: 'fantasy', lineHeight: 21,marginBottom:18 }}>2010--{I18n.t('DavidActivity.alumni')} <Text style={{ fontWeight: '700', fontStyle: 'italic', fontFamily: 'fantasy' }}> {I18n.t('DavidActivity.award')}</Text></Text>
//         <Text style={{ fontFamily: 'fantasy', lineHeight: 21,marginBottom:18 }}>2009--{I18n.t('DavidActivity.medical')}<Text style={{ fontWeight: '700', fontStyle: 'italic', fontFamily: 'fantasy' }}> {I18n.t('DavidActivity.award')}</Text></Text>
//     </View>
// );
            ...
            <ScrollView>
                ...
                <View style={{ backgroundColor: '#0383DE' }}>
                    ...
                    <View style={{ backgroundColor: '#F0F0F0', borderTopLeftRadius: 20, borderTopRightRadius: 20 }}>
                        <View style={{ width: '90%', }}>
                            <Image style={{ height: 99, width: '100%', marginTop: -60, marginLeft: -60 }} resizeMode="contain" source={require("../image/icons/david.png")}></Image>
                        </View>
                        <View style={{ width: '90%', alignSelf: 'center', justifyContent: 'center', marginBottom: 20, marginTop: 23, paddingBottom: 20, borderStyle: "dashed", borderBottomWidth: 0.5 }}>
                            <Text style={{ fontSize: 18, lineHeight: 44, textAlign: 'left', marginLeft: 20, color: '#0071bc' }}>{I18n.t("DavidActivity.title")}</Text>
                            <Text style={{ fontSize: 16, lineHeight: 18, textAlign: 'left', marginLeft: 20, }}>{I18n.t("DavidActivity.senior")}</Text>
                            <Text style={{ fontSize: 14, lineHeight: 18, textAlign: 'left', marginLeft: 20, fontStyle: 'italic' }}>{I18n.t("DavidActivity.hkg")}</Text>
                        </View>
                        {/* 專業履歷 */}
                        {/* <View style={{ marginBottom: 20, backgroundColor: '#f0f0f0' }}>
                    <Text style={{ width: '90%', height: 67, alignSelf: 'center', fontFamily: 'fantasy', fontSize: 18, lineHeight: 67, fontWeight: 'bold' }}>{I18n.t('DavidActivity.professional')}</Text>
                </View>
                ...
                <View style={{ width: '100%', flexDirection: 'row' }} >
                    ...
                    <Text style={{ width: '70%', height: 16, lineHeight: 17, fontFamily: 'fantasy', paddingLeft: 10 }}>{I18n.t('DavidActivity.hong')}</Text>
                </View>
                <View style={{ flexDirection: 'row', }}>
                    <Text style={{ width: '28%', height: 56, fontFamily: 'fantasy', borderRightColor: '#e4d8d8', borderRightWidth: 1, textAlign: 'center' }}>
                    </Text>
                    <Text style={{ width: '70%', height: 56, lineHeight: 18, fontFamily: 'fantasy', paddingLeft: 19 }}><Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineHeight: 27 }}>{I18n.t("DavidActivity.senior")}</Text> </Text>
                </View>
                <View style={{ width: '100%', flexDirection: 'row' }} >
                    <Text style={{ width: '25%', height: 17, lineHeight: 19, fontFamily: 'fantasy', textAlign: 'center' }}>2016-now
                        </Text>
                    <Text style={{ alignSelf: 'flex-end', width: '5%', height: 18, backgroundColor: '#0071bc', borderRadius: 30, }}></Text>
                    <Text style={{ width: '70%', height: 16, lineHeight: 17, fontFamily: 'fantasy', paddingLeft: 10 }}>{I18n.t('DavidActivity.montreal')}</Text>
                </View>
                <View style={{ flexDirection: 'row', }}>
                    ...
                    <View style={{ width: '70%', height: 68, paddingLeft: 19 }} >
                        <Text style={{ lineHeight: 18, fontFamily: 'fantasy' }}>{I18n.t('DavidActivity.canada')}</Text>
                        <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineHeight: 34, }}>{I18n.t('DavidActivity.founder')}</Text>
                    </View>
                </View>
                <View style={{ width: '100%', flexDirection: 'row' }} >
                    <Text style={{ width: '25%', height: 17, lineHeight: 19, fontFamily: 'fantasy', textAlign: 'center' }}>2016-2017
                        </Text>
                    <Text style={{ alignSelf: 'flex-end', width: '5%', height: 18, backgroundColor: '#0071bc', borderRadius: 30, }}></Text>
                    <Text style={{ width: '70%', height: 16, lineHeight: 17, fontFamily: 'fantasy', paddingLeft: 10 }}>{I18n.t('DavidActivity.department')}</Text>
                </View>
                <View style={{ flexDirection: 'row', }}>
                    <Text style={{ width: '28%', height: 68, fontFamily: 'fantasy', borderRightColor: '#e4d8d8', borderRightWidth: 1, textAlign: 'center' }}></Text>

                    <View style={{ width: '70%', height: 68, paddingLeft: 19 }} >
                        <Text style={{ lineHeight: 18, fontFamily: 'fantasy' }}>{I18n.t('DavidActivity.mcgill')}</Text>
                        <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineHeight: 34, }}>{I18n.t('DavidActivity.research')}</Text>
                    </View>
                </View>
                <View style={{ width: '100%', flexDirection: 'row' }} >
                    <Text style={{ width: '25%', height: 17, lineHeight: 19, fontFamily: 'fantasy', textAlign: 'center' }}>2011-2016
                        </Text>
                    <Text style={{ alignSelf: 'flex-end', width: '5%', height: 18, backgroundColor: '#0071bc', borderRadius: 30, }}></Text>
                    <Text style={{ width: '70%', height: 16, lineHeight: 17, fontFamily: 'fantasy', paddingLeft: 10 }}>{I18n.t('DavidActivity.department')}</Text>
                </View>
                <View style={{ flexDirection: 'row', }}>
                    ...
                    <View style={{ width: '70%', height: 68, paddingLeft: 19 }} >
                        <Text style={{ lineHeight: 18, fontFamily: 'fantasy' }}>{I18n.t('DavidActivity.university')}</Text>
                        <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineHeight: 45, }}>{I18n.t('DavidActivity.fellowed')}</Text>
                    </View>
                </View>
                <View style={{ width: '100%', flexDirection: 'row' }} >
                    <Text style={{ width: '25%', height: 17, lineHeight: 19, fontFamily: 'fantasy', textAlign: 'center' }}>2004-2011
                        </Text>
                    <Text style={{ alignSelf: 'flex-end', width: '5%', height: 18, backgroundColor: '#0071bc', borderRadius: 30, }}></Text>
                    <Text style={{ width: '70%', height: 16, lineHeight: 17, fontFamily: 'fantasy', paddingLeft: 10 }}>{I18n.t('DavidActivity.hebrew')}</Text>
                </View>
                <View style={{ flexDirection: 'row', }}>
                    <Text style={{ width: '28%', height: 68, fontFamily: 'fantasy', borderRightColor: '#e4d8d8', borderRightWidth: 1, textAlign: 'center' }}>
                    </Text>
                    <View style={{ width: '70%', height: 68, paddingLeft: 19 }} >
                        <Text style={{ lineHeight: 18, fontFamily: 'fantasy' }}>{I18n.t('DavidActivity.school')}</Text>
                        <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineHeight: 45, }}>{I18n.t('DavidActivity.assistant')}</Text>
                    </View>
                </View> */}
                ...
                /> */}
                    ...
                    <Text style={{ width: '90%', height: 56, alignSelf: 'center', fontFamily: 'fantasy', fontSize: 18, fontWeight: 'bold', lineHeight: 56 }} >{I18n.t('DavidActivity.publshed')}</Text>
                </View>
                <View style={{ backgroundColor: '#1f96f4', paddingTop: 20, paddingBottom: 20 }}>
                    <View style={{ width: '90%', height: 77, alignSelf: 'center' }}>
                        <TouchableOpacity onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/29924424" }); this.setState({ display: true }) }}>
                            <Text style={{ fontFamily: 'fantasy', fontSize: 14, color: '#ffffff' }}>Identification of an Epigenetic Signature of Osteoporosis in Blood DNA of Postmenopausal Women. JBMR. 2018;</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ width: '90%', height: 67, alignSelf: 'center' }}>
                        <TouchableOpacity onPress={() => { this.setState({ url: "https://bmccancer.biomedcentral.com/articles/10.1186/s12885-018-4482-7" }); this.setState({ display: true }) }}>
                            <Text style={{ fontFamily: 'fantasy', fontSize: 14, color: '#ffffff' }}>DNA methylation signatures of breast cancer in peripheral T-cells. BMC  Cancer.2018;</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ width: '90%', height: 67, alignSelf: 'center' }}>
                        <TouchableOpacity onPress={() => { this.setState({ url: "https://clinicalepigeneticsjournal.biomedcentral.com/articles/10.1186/s13148-017-0436-1" }); this.setState({ display: true }) }}>
                            <Text style={{ fontFamily: 'fantasy', fontSize: 14, color: '#ffffff' }}>The signature of liver cancer in immune cells DNA methylation. Clin Epigenetics.2018;</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ width: '90%', height: 77, alignSelf: 'center' }}>
                        <TouchableOpacity onPress={() => { this.setState({ url: "https://www.onlinelibrary.wiley.com/doi/full/10.1002/mnfr.201701008" }); this.setState({ display: true }) }}>
                            <Text style={{ fontFamily: 'fantasy', fontSize: 14, color: '#ffffff' }}>Personalized cardio-metabolic responses to an anti-inflammatory nutrition intervention in obese adolescents: a randomized controlled crossover trial.</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ width: '90%', height: 77, alignSelf: 'center' }}>
                        <TouchableOpacity onPress={() => { this.setState({ url: "https://www.sciencedirect.com/science/article/abs/pii/S1094695016301780" }); this.setState({ display: true }) }}>
                            <Text style={{ fontFamily: 'fantasy', fontSize: 14, color: '#ffffff' }}>Genetic polymorphisms in ESR1 and VDR genes do not correlate with osteoporosis with familial dysautonomia.  J Clin Densitom.2018;</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ width: '90%', height: 77, alignSelf: 'center' }}>
                        <TouchableOpacity onPress={() => { this.setState({ url: "https://www.greenmedinfo.health/article/methyl-donor-s-adenosylmethionine-sam-supplementation-attenuates-breast-cancer" }); this.setState({ display: true }) }}>
                            <Text style={{ fontFamily: 'fantasy', fontSize: 14, color: '#ffffff' }}>Methyl donor S-adenosylmethionine (SAM) supplementation attenuates breast cancer growth, invasion, and metastasis in vivo; therapeutic and chemopreventive applications.Oncotarget. 2017;</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ width: '90%', height: 77, alignSelf: 'center' }}>
                        <TouchableOpacity onPress={() => { this.setState({ url: "https://academic.oup.com/nar/article/45/22/12681/4259028" }); this.setState({ display: true }) }}>
                            <Text style={{ fontFamily: 'fantasy', fontSize: 14, color: '#ffffff' }}>Epigenetic mechanisms underlie the crosstalk between growth factors and a steroid hormone.Nucleic Acids Res. 2017;</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ width: '90%', height: 77, alignSelf: 'center' }}>
                        <TouchableOpacity onPress={() => { this.setState({ url: "https://www.researchgate.net/publication/316689941_DNA_methylation_controls_unmethylated_transcription_start_sites_in_the_genome_in_trans" }); this.setState({ display: true }) }}>
                            <Text style={{ fontFamily: 'fantasy', fontSize: 14, color: '#ffffff' }}> DNA methylation controls unmethylated transcription start sites in the genome in trans”. Epigenomics . 2017;</Text>
                        </TouchableOpacity>
                    </View>
                </View> */}
