    ...
    render() {
        ...
        return (
            <ScrollView>
                ...
                {/* 发表论文 */}
                <View>
                    <Text style={{ width: '90%', height: 67, alignSelf: 'center', fontFamily: 'NotoSansHans-Light', fontSize: 28, lineHeight: 67, fontWeight: 'bold' }}>{I18n.t('DavidActivity.publshed')}</Text>
                </View>
                <View style={{ marginTop: 20, marginBottom: 20 }}>
                    ...
                    <View style={{ alignSelf: 'center', width: '90%', alignSelf: 'center', borderBottomWidth: 0.5, borderStyle: 'solid' }}>
                        <TouchableOpacity onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/29924424" }); this.setState({ display: true }) }}>
                            <Text style={{ height: 80, lineHeight: 25, fontFamily: 'NotoSansHans-Light', fontSize: 14, fontWeight: '700', color: '#3B3B3B' }}>Identification of an Epigenetic Signature of 
                    ...
                    <View style={{ alignSelf: 'center', width: '90%', alignSelf: 'center', borderBottomWidth: 0.5, borderStyle: 'solid' }}>
                        <TouchableOpacity onPress={() => { this.setState({ url: "https://bmccancer.biomedcentral.com/articles/10.1186/s12885-018-4482-7" }); this.setState({ display: true }) }}>
                            <Text style={{ height: 60, lineHeight: 25, fontFamily: 'NotoSansHans-Light', fontSize: 14, fontWeight: '700', color: '#3B3B3B' }}>
