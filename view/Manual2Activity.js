            ...
            <ScrollView style={{flex:1}}>
                ...
                <View style={{ width: '90%', alignSelf: 'center', marginTop: px2dp(20), paddingBottom: px2dp(20), }}>
                    ...
                    <View style={{ flexDirection: 'row',marginBottom:18 }}>
                        ...
                        <Text style={{  width: '95%', fontSize: px2dp(16),  fontFamily: 'fantasy', lineHeight:px2dp(20)  }}>{I18n.t('Manual2Activity.download')}</Text>
                    </View>
                    <View style={{ flexDirection: 'row',marginBottom:18 }}>
                        <Text style={{  width: '7%', fontSize: px2dp(16), fontWeight: 'bold',fontFamily: 'fantasy' ,lineHeight:px2dp(20) }}>2.</Text>
                        <Text style={{  width: '95%', fontSize: px2dp(16),  fontFamily: 'fantasy', lineHeight:px2dp(20) }}>{I18n.t('Manual2Activity.gocenter')}</Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row',marginTop:23,marginBottom:18}}>
                        ...
                        <Text style={{  width: '95%',fontSize: px2dp(16),  fontFamily: 'fantasy' , lineHeight:px2dp(20)  }}>{I18n.t('Manual2Activity.fillregis')}</Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row',marginTop:23,marginBottom:7 }}>
                        ...
                        <Text style={{ width: '95%', fontSize: px2dp(16), fontFamily: 'fantasy', lineHeight:px2dp(20) }}>{I18n.t('Manual2Activity.mailbox')}</Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row',marginTop:23 }}>
                        ...
                        <Text style={{ width: '95%', fontSize: px2dp(16),fontFamily: 'fantasy', lineHeight:px2dp(20)}}>{I18n.t('Manual2Activity.accountlogin')}</Text>
                    </View>
                    <Image style={{ width: '100%', height: px2dp(400) }} source={require('../image/enpic/get4.png')} resizeMode='contain' />
                    <View style={{ flexDirection: 'row',marginTop:23 }}>
                        <Text style={{  width: '7%', fontSize: px2dp(16), fontWeight: 'bold',fontFamily: 'fantasy', lineHeight:px2dp(20) }}>6.</Text>
                        <Text style={{  width: '95%', fontSize: px2dp(16), fontFamily: 'fantasy', lineHeight:px2dp(20) }}>{I18n.t('Manual2Activity.setkey')}</Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row',marginTop:23 }}>
                        ...
                        <Text style={{ fontSize: 16, lineHeight:px2dp(20)}}>{I18n.t('Manual2Activity.sentmail')}</Text>
                    </View>
                    <Image style={{ width: '100%', height: px2dp(430) }} source={require('../image/enpic/get6.png')} resizeMode='contain' />
                    <View style={{ flexDirection: 'row',marginTop:23, }}>
                        <Text style={{ width: '7%', fontSize: px2dp(16), fontWeight: 'bold',fontFamily: 'fantasy', lineHeight:px2dp(20) }}>7.</Text>
                        <Text style={{  width: '95%', fontSize: px2dp(16), fontFamily: 'fantasy', lineHeight:px2dp(20) }}>{I18n.t('Manual2Activity.purchase')}</Text>
                    </View>
