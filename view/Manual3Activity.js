            ...
            <ScrollView>
               <StatusBar animated={true}  hidden={true} translucent={true} barStyle={'light-content'} />
                ...
                <View style={{ width: '90%', alignSelf: 'center', marginTop: px2dp(20), paddingBottom: px2dp(20), }}>
                    <Text style={{ textAlign: 'center', fontSize: px2dp(20),marginBottom:px2dp(20),color:'#000', fontFamily: 'fantasy', fontWeight: 'bold', textAlignVertical: 'center' }}>{I18n.t("QAActivity.how")}</Text>
                    <View style={{ flexDirection: 'row' }}>
                        <Text style={{  width: '7%', fontSize: px2dp(16), fontWeight: 'bold',color:'#000',fontFamily:'fantasy',lineHeight:px2dp(20) }}>1.</Text>
                        <Text style={{  width: '95%', fontSize:  px2dp(16), marginBottom: 8,color:'#000', fontFamily: 'fantasy', lineHeight: px2dp(20) }}>{I18n.t("QAActivity.slider1")}</Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={{  width: '95%', fontSize:  px2dp(16), marginBottom: 8,color:'#000', fontFamily: 'fantasy', lineHeight: px2dp(20) }}>{I18n.t("QAActivity.ratingstart2")}</Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={{  width: '95%', fontSize:  px2dp(16), marginBottom: 8,color:'#000', fontFamily: 'fantasy', lineHeight: px2dp(20) }}>{I18n.t("QAActivity.enteefield3")}</Text>
                    </View>
