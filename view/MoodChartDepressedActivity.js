...
export default class MoodChartDepressedActivity extends Component<Props> {
    static navigationOptions = ({ navigation, screenProps }) => {
        return ({
            title: I18n.t('LifeStyleChartActivity.Depressed'),
        })
    }
    constructor(props) {
        super(props);
                    ...
                    <MoodChart
                        title={
                            <View style={{ width: "90%", marginTop: px2dp(20), marginBottom: px2dp(20) }}>
                                <Text style={{ fontSize: px2dp(16), fontFamily: 'fantasy', color: '#000' }}>{I18n.t('MoodChartActivity.hopeless')}</Text>
                            </View>
                        }
