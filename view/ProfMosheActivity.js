                    ...
                    <View style={{ width: '90%', height: 740,  alignSelf: 'center' }}>
                        ...
                        <TouchableOpacity onPress={() => this.navigate.push("ProfMosheVideos")}>
                            <View style={{  borderColor:'#D6D7D8',borderRadius: 15,borderWidth:1, height: 80, flexDirection: 'row', marginBottom: 20 }}>
                                ...
                                <View style={{ width: '65%', justifyContent: 'center' }}>
                                    <Text style={{ fontSize: 18, textAlign: 'left', fontFamily: 'NotoSansHans-Light', color:'#0A0A0A',fontWeight:'700' }}>Related Videos
                                    </Text>
                                </View>
                                <View style={{ width: '15%', height: 80, justifyContent: 'center' }}>
                                    <Text style={{ fontSize: 20, fontFamily: 'NotoSansHans-Light', color: '#898989', textAlign: 'center',fontWeight:'700' }}> &gt; </Text>
                        ...
                        <TouchableOpacity onPress={() => this.navigate.push("ProfMosheSponsored")}>
                            <View style={{ borderColor:'#D6D7D8', borderRadius: 15,borderWidth:1, height: 80, flexDirection: 'row', marginBottom: 20 }}>
                                ...
                                <View style={{ width: '65%', justifyContent: 'center' }}>
                                    <Text style={{ fontSize: 18, textAlign: 'left', fontFamily: 'NotoSansHans-Light', color:'#0A0A0A',fontWeight:'700' }}>Sponsored
                                    </Text>
                                </View>
                                <View style={{ width: '15%', height: 80, justifyContent: 'center' }}>
                                    <Text style={{ fontSize: 20, fontFamily: 'NotoSansHans-Light', color: '#898989', textAlign: 'center',fontWeight:'700' }}> &gt; </Text>
