...
//                 <Text style={{ lineHeight:px2dp(18), fontFamily: 'fantasy' }}>{I18n.t('ProfMosheActivity.pharmacology2')}</Text>
//                 <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineheight:px2dp(45), }}>{I18n.t('ProfMosheActivity.chairman')}</Text>
//             </View>
...
//             <Text style={{ width: '28%', height: 68, fontFamily: 'fantasy', borderRightColor: '#e4d8d8', borderRightWidth: 1, textAlign: 'center' }}>
//             </Text>
//             <Text style={{ width: '70%', height: 68, lineHeight:px2dp(18), fontFamily: 'fantasy', paddingLeft: 19 }}> <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineHeight: 27 }}> {I18n.t('ProfMosheActivity.professor2')}</Text> </Text>
//         </View>
//         <View style={{ width: '100%', flexDirection: 'row' }} >
...
//             <View style={{ width: '70%', height: 68, paddingLeft: 19 }} >
//                 <Text style={{ lineHeight:px2dp(18), fontFamily: 'fantasy' }}>{I18n.t('ProfMosheActivity.themcgill')}</Text>
//                 <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineheight:px2dp(45), }}>{I18n.t('ProfMosheActivity.professor2')}</Text>
//             </View>
//         </View>
//         <View style={{ width: '100%', flexDirection: 'row' }} >
...
//             </Text>
//             <View style={{ width: '70%', height: 68, paddingLeft: 19 }} >
//                 <Text style={{ lineHeight:px2dp(18), fontFamily: 'fantasy' }}>{I18n.t('ProfMosheActivity.school')}</Text>
//                 <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineheight:px2dp(45), }}>{I18n.t('ProfMosheActivity.Associate')}</Text>
//             </View>
//         </View>
//         <View style={{ width: '100%', flexDirection: 'row' }} >
...
//                 <Text style={{ lineHeight:px2dp(18), fontFamily: 'fantasy' }}>{I18n.t('ProfMosheActivity.team')}</Text>
//                 <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineheight:px2dp(45), }}>C$166,666</Text>
//             </View>
...
//             </Text>
//             <View style={{ width: '70%', height: 88, paddingLeft: 19 }} >
//                 <Text style={{ lineHeight:px2dp(18), fontFamily: 'fantasy' }}>{I18n.t('ProfMosheActivity.analysis')}</Text>
//                 <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineheight:px2dp(45), }}>C$141,000</Text>
//             </View>
...
//             </Text>
//             <View style={{ width: '70%', height: 88, paddingLeft: 19 }} >
//                 <Text style={{ lineHeight:px2dp(18), fontFamily: 'fantasy' }}>{I18n.t('ProfMosheActivity.prospect')} </Text>
//                 <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineheight:px2dp(45), }}>C$168,158</Text>
//             </View>
...
//             </Text>
//             <View style={{ width: '70%', height: 68, paddingLeft: 19 }} >
//                 <Text style={{ lineHeight:px2dp(18), fontFamily: 'fantasy' }}>{I18n.t('ProfMosheActivity.science')}</Text>
//                 <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineheight:px2dp(45), }}>C$145,500</Text>
//             </View>
...
//             <View style={{ width: '70%', height: 68, paddingLeft: 19 }} >
//                 <Text style={{ lineHeight:px2dp(18), fontFamily: 'fantasy' }}> {I18n.t('ProfMosheActivity.school')}</Text>
//                 <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineheight:px2dp(45), }}>C$74,592/year</Text>
//             </View>
            ...
            <ScrollView style={{ flex: 1 }}>
                ...
                <View style={{ backgroundColor: '#e5e6e7' }}>
                    ...
                    <View style={{ backgroundColor: '#f0f0f0', }}>
                        <Text style={{ width: '90%', height: 67, alignSelf: 'center', fontFamily: 'fantasy', fontSize:px2dp(18), lineHeight: 67, fontWeight: 'bold' }}>{I18n.t('ProfMosheActivity.experiences')}</Text>
                    </View>
                ...
                <View style={{ paddingTop: 20, paddingBottom: 20, backgroundColor: '#f0f0f0' }}>
                    <View style={{ width: '90%', alignSelf: 'center' }}>
                        <Text style={{ width: '90%', height: 67, fontFamily: 'fantasy', fontSize:px2dp(18), lineHeight: 67, fontWeight: 'bold' }}>{I18n.t('ProfMosheActivity.video')}</Text>
                ...
                /> */}
                        ...
                        {/* 荣誉 */}
                        {/* <View style={{ backgroundColor: '#f0f0f0' }}>
                    <Text style={{ width: '90%', height: 56, alignSelf: 'center', fontFamily: 'fantasy', fontSize:px2dp(18), fontWeight: 'bold', lineHeight: 56 }} >{I18n.t('ProfMosheActivity.papers')}</Text>
                </View>
                <View style={{ backgroundColor: '#1f96f4', paddingTop: 20, paddingBottom: 20 }}>
                    <View style={{ flexDirection: 'row', width: '90%', height: 88, alignSelf: 'center' }}>
                        <TouchableOpacity style={{ width: '80%' }} onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/15220929" }); this.setState({ display: true }) }}>
                            <Text style={{ width: '100%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>Epigenetic programming by
                            maternal behavior.Aug 1st 2004  Nature Neuroscience volume 7 issue 8 pp 847-854</Text>
                        </TouchableOpacity>

                        <Text style={{ width: '20%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>5530 Citations</Text>
                    </View>
                    <View style={{ flexDirection: 'row', width: '90%', height: 77, alignSelf: 'center' }}>
                        <TouchableOpacity style={{ width: '80%' }} onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/19234457" }); this.setState({ display: true }) }}>
                            <Text style={{ width: '100%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>Epigenetic regulation of the
                            glucocorticoid receptor in human brain associates with childhood abuse. Nat Neurosci .2009 Mar; 12(3): 342–348.</Text>
                        </TouchableOpacity>
                        <Text style={{ width: '20%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>2892 Citations</Text>
                    </View>
                    <View style={{ flexDirection: 'row', width: '90%', height: 67, alignSelf: 'center' }}>
                        <TouchableOpacity style={{ width: '80%' }} onPress={() => { this.setState({ url: 'https://www.ncbi.nlm.nih.gov/pubmed/10050851' }); this.setState({ display: true }) }}>
                            <Text style={{ width: '100%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>A mammalian protein with specific
                            demethylase activity for mCpG DNA.  Nature .1999 Feb 18</Text>
                        </TouchableOpacity>
                        <Text style={{ width: '20%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>528 Citations</Text>
                    </View>
                    <View style={{ flexDirection: 'row', width: '90%', height: 67, alignSelf: 'center' }}>
                        <TouchableOpacity style={{ width: '80%' }} onPress={() => { this.setState({ url: 'https://www.ncbi.nlm.nih.gov/pubmed/18461137' }); this.setState({ display: true }) }}>
                            <Text style={{ width: '100%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>Promoter-wide hypermethylation of
                            the ribosomal RNA gene promoter in the suicide brain.  PLoS One . 2008 May 7</Text>
                        </TouchableOpacity>
                        <Text style={{ width: '20%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>351 Citations</Text>
                    </View>
                    <View style={{ flexDirection: 'row', width: '90%', height: 67, alignSelf: 'center' }}>
                        <TouchableOpacity style={{ width: '80%' }} onPress={() => { this.setState({ url: 'https://www.ncbi.nlm.nih.gov/pubmed/21386994' }); this.setState({ display: true }) }}>
                            <Text style={{ width: '100%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>Broad epigenetic signature of
                            maternal care in the brain of adult rats.  PLoS One .2011 Feb 28</Text>
                        </TouchableOpacity>
                        <Text style={{ width: '20%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>347 Citations</Text>
                    </View>
                    <View style={{ flexDirection: 'row', width: '90%', height: 67, alignSelf: 'center' }}>
                        <TouchableOpacity style={{ width: '80%' }} onPress={() => { this.setState({ url: 'https://www.ncbi.nlm.nih.gov/pubmed/7713905' }); this.setState({ display: true }) }}>
                            <Text style={{ width: '100%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>Expression of antisense to DNA
                            demethylation and inhibits tumorigenesis. J Biol Chem. 1995 Apr 7</Text>
                        </TouchableOpacity>
                        <Text style={{ width: '20%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>256 Citations</Text>
                    </View>
                    <View style={{ flexDirection: 'row', width: '90%', height: 78, alignSelf: 'center' }}>
                        <TouchableOpacity style={{ width: '80%' }} onPress={() => { this.setState({ url: 'https://www.ncbi.nlm.nih.gov/pubmed/18851683' }); this.setState({ display: true }) }}>
                            <Text style={{ width: '100%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>Epigenetics, DNA methylation,
                            and chromatin modifying drugs. Annu Rev Pharmacol Toxicol. 2009;49</Text>
                        </TouchableOpacity>
                        <Text style={{ width: '20%', fontFamily: 'fantasy', fontSize:px2dp(14), color: '#ffffff' }}>432 Citations</Text>
                    </View>
                    <View style={{ flexDirection: 'row', width: '90%', height: 88, alignSelf: 'center' }}>
                        ...
                        <View style={{ marginTop: 40 }}>
                            <View style={{ width: '90%', height: 740, alignSelf: 'center' }}>
                                ...
                                <TouchableOpacity onPress={() => this.navigate.push("ProfMosheExperiences")} >
                                    <View style={{ borderRadius:px2dp(15), borderWidth: 1, borderColor: '#D6D7D8', height:px2dp(80), flexDirection: 'row', backgroundColor: '#ffffff', }}>
                                        ...
                                        <View style={{ width: '65%', justifyContent: 'center' }}>
                                            <Text style={{ fontSize:px2dp(18), textAlign: 'left', fontFamily: 'fantasy', color: '#0A0A0A', fontWeight: '700' }}>{I18n.t('ProfMosheActivity.experiences')}
                                            </Text>
                                        </View>
                                ...
                                <TouchableOpacity onPress={() => this.navigate.push("ProfMosheVideos")}>
                                    <View style={{ borderColor: '#D6D7D8', borderRadius:px2dp(15), borderWidth: 1, height:px2dp(80), flexDirection: 'row', backgroundColor: '#ffffff', }}>
                                        <View style={{ width: '20%', justifyContent: 'center' }}>
                                            <Image style={{ width: '100%', height:px2dp(45) }} source={require('../image/icons/pro2.png')} resizeMode='contain' />
                                        </View>
                                        <View style={{ width: '65%', justifyContent: 'center' }}>
                                            <Text style={{ fontSize:px2dp(18), textAlign: 'left', fontFamily: 'fantasy', color: '#0A0A0A', fontWeight: '700' }}>{I18n.t('ProfMosheActivity.video')}
                                            </Text>
                                        </View>
                                        <View style={{ width: '15%', height:px2dp(80), justifyContent: 'center' }}>
                                            <Text style={{ fontSize:px2dp(20), fontFamily: 'fantasy', color: '#898989', textAlign: 'center', fontWeight: '700' }}> &gt; </Text>
                                ...
                                <TouchableOpacity onPress={() => this.navigate.push("ProfMosheCareer")}>
                                    <View style={{ borderColor: '#D6D7D8', borderRadius:px2dp(15), borderWidth: 1, height:px2dp(80), flexDirection: 'row', backgroundColor: '#ffffff', }}>
                                        ...
                                        <View style={{ width: '65%', justifyContent: 'center' }}>
                                            <Text style={{ fontSize:px2dp(18), textAlign: 'left', fontFamily: 'fantasy', color: '#0A0A0A', fontWeight: '700' }}>{I18n.t('ProfMosheActivity.Career')}
                                            </Text>
                                        </View>
                                        <View style={{ width: '15%', height:px2dp(80), justifyContent: 'center' }}>
                                            <Text style={{ fontSize:px2dp(20), fontFamily: 'fantasy', color: '#898989', textAlign: 'center', fontWeight: '700' }}> &gt; </Text>
                                ...
                                <TouchableOpacity onPress={() => this.navigate.push("ProfMosheHonors")}>
                                    <View style={{ borderColor: '#D6D7D8', borderRadius:px2dp(15), borderWidth: 1, height:px2dp(80), flexDirection: 'row', backgroundColor: '#ffffff', }}>
                                        ...
                                        <View style={{ width: '65%', justifyContent: 'center' }}>
                                            <Text style={{ fontSize:px2dp(18), textAlign: 'left', fontFamily: 'fantasy', color: '#0A0A0A', fontWeight: '700' }}>{I18n.t('ProfMosheActivity.Honors')}
                                            </Text>
                                        </View>
                                        <View style={{ width: '15%', height:px2dp(80), justifyContent: 'center' }}>
                                            <Text style={{ fontSize:px2dp(20), fontFamily: 'fantasy', color: '#898989', textAlign: 'center', fontWeight: '700' }}> &gt; </Text>
                                ...
                                <TouchableOpacity onPress={() => this.navigate.push("ProfMosheSponsored")}>
                                    <View style={{ borderColor: '#D6D7D8', borderRadius:px2dp(15), borderWidth: 1, height:px2dp(80), flexDirection: 'row', backgroundColor: '#ffffff', }}>
                                        <View style={{ width: '20%', justifyContent: 'center' }}>
                                            <Image style={{ width: '100%', height:px2dp(45) }} source={require('../image/icons/pro5.png')} resizeMode='contain' />
                                        </View>
                                        <View style={{ width: '65%', justifyContent: 'center' }}>
                                            <Text style={{ fontSize:px2dp(18), textAlign: 'left', fontFamily: 'fantasy', color: '#0A0A0A', fontWeight: '700' }}>{I18n.t('ProfMosheActivity.Sponsored')}
                                            </Text>
                                        </View>
                                        <View style={{ width: '15%', height:px2dp(80), justifyContent: 'center' }}>
                                            <Text style={{ fontSize:px2dp(20), fontFamily: 'fantasy', color: '#898989', textAlign: 'center', fontWeight: '700' }}> &gt; </Text>
                                ...
                                <TouchableOpacity onPress={() => this.navigate.push("ProfMoshePublished")}>
                                    <View style={{ borderColor: '#D6D7D8', borderRadius:px2dp(15), borderWidth: 1, height:px2dp(80), flexDirection: 'row', backgroundColor: '#ffffff', }}>
                                        ...
                                        <View style={{ width: '65%', justifyContent: 'center' }}>
                                            <Text style={{ fontSize:px2dp(18), textAlign: 'left', fontFamily: 'fantasy', color: '#0A0A0A', fontWeight: '700' }}>{I18n.t('ProfMosheActivity.papers')}
                                            </Text>
                                        </View>
                                        <View style={{ width: '15%', height:px2dp(80), justifyContent: 'center' }}>
                                            <Text style={{ fontSize:px2dp(20), fontFamily: 'fantasy', color: '#898989', textAlign: 'center', fontWeight: '700' }}> &gt; </Text>
