        ...
        return (
            <ScrollView style={{ flex: 1 }}>
                ...
                <View style={{ backgroundColor: '#f0f0f0' }}>
                    <Text style={{ width: '90%', height: px2dp(56), alignSelf: 'center', fontFamily: 'fantasy', fontSize:px2dp(18), fontWeight: 'bold', lineheight: px2dp(56) }} >{I18n.t('ProfMosheActivity.papers')}</Text>
                </View>
