                ...
                <View style={{  paddingTop: 20, paddingBottom: 20 }}>
                    ...
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/19234457" }); this.setState({ display: true }) }}>
                            <Text style={{ height:60,lineHeight:30, fontFamily: 'NotoSansHans-Light', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Epigenetic regulation of the
                    ...
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/10050851" }); this.setState({ display: true }) }}>
                            <Text style={{ height:60,lineHeight:30, fontFamily: 'NotoSansHans-Light', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>A mammalian protein with specific
                    ...
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/18461137" }); this.setState({ display: true }) }}>
                            <Text style={{ height:60,lineHeight:30, fontFamily: 'NotoSansHans-Light', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Promoter-wide hypermethylation of
                    ...
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/21386994" }); this.setState({ display: true }) }}>
                            <Text style={{ height:60,lineHeight:30, fontFamily: 'NotoSansHans-Light', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Broad epigenetic signature of
                    ...
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/7713905" }); this.setState({ display: true }) }}>
                            <Text style={{ height:60,lineHeight:30, fontFamily: 'NotoSansHans-Light', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Expression of antisense to DNA
                    ...
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/18851683" }); this.setState({ display: true }) }}>
                            <Text style={{ height:60,lineHeight:30, fontFamily: 'NotoSansHans-Light', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Epigenetics, DNA methylation,
                    ...
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/16484373" }); this.setState({ display: true }) }}>
                            <Text style={{ height:90,lineHeight:30, fontFamily: 'NotoSansHans-Light', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Maternal care effects on the
