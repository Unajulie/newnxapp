                ...
                <View style={{  paddingTop: 20, paddingBottom: 20 }}>
                    ...
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/15220929" }); this.setState({ display: true }) }}>
                            <Text style={{ height:36,lineHeight:36, fontFamily: 'fantasy', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Epigenetic programming by
                        ...
                        <Text style={{ height:26,lineHeight:26, fontFamily: 'fantasy', fontSize: 16, fontWeight:'700',color:'#101112' }}>5530 Citations</Text>
                        <View style={{height:15}}></View>
                    </View>
                    <View style={{height:15}}></View>
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/19234457" }); this.setState({ display: true }) }}>
                            <Text style={{ height:60,lineHeight:30, fontFamily: 'fantasy', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Epigenetic regulation of the
                            glucocorticoid receptor in human brain associates with childhood abuse.</Text>
                            <Text style={{ height:36,lineHeight:36, fontFamily: 'fantasy', fontSize: 14,color:'#626471'  }}>
                            Nat Neurosci .2009 Mar; 12(3): 342–348</Text>
                        </TouchableOpacity>
                        <Text style={{ height:26,lineHeight:26, fontFamily: 'fantasy', fontSize: 16, fontWeight:'700',color:'#101112' }}>2892 Citations</Text>
                        <View style={{height:15}}></View>
                    </View>
                    <View style={{height:15}}></View>
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/10050851" }); this.setState({ display: true }) }}>
                            <Text style={{ height:60,lineHeight:30, fontFamily: 'fantasy', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>A mammalian protein with specific
                            demethylase activity for mCpG DNA.</Text>
                            <Text style={{ height:36,lineHeight:36, fontFamily: 'fantasy', fontSize: 14,color:'#626471'  }}>
                            Nature 1999 Feb 18</Text>
                        </TouchableOpacity>
                        <Text style={{ height:26,lineHeight:26, fontFamily: 'fantasy', fontSize: 16, fontWeight:'700',color:'#101112' }}>528 Citations</Text>
                        <View style={{height:15}}></View>
                    </View>
                    <View style={{height:15}}></View>
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/18461137" }); this.setState({ display: true }) }}>
                            <Text style={{ height:60,lineHeight:30, fontFamily: 'fantasy', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Promoter-wide hypermethylation of
                            the ribosomal RNA gene promoter in the suicide brain. </Text>
                            <Text style={{ height:36,lineHeight:36, fontFamily: 'fantasy', fontSize: 14,color:'#626471'  }}>
                            PLoS One 2008 May 7</Text>
                        </TouchableOpacity>
                        <Text style={{ height:26,lineHeight:26, fontFamily: 'fantasy', fontSize: 16, fontWeight:'700',color:'#101112' }}>351 Citations</Text>
                        <View style={{height:15}}></View>
                    </View>
                    <View style={{height:15}}></View>
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/21386994" }); this.setState({ display: true }) }}>
                            <Text style={{ height:60,lineHeight:30, fontFamily: 'fantasy', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Broad epigenetic signature of
                            maternal care in the brain of adult rats. </Text>
                            <Text style={{ height:36,lineHeight:36, fontFamily: 'fantasy', fontSize: 14,color:'#626471'  }}>
                            PLoS One 2011 Feb 28</Text>
                        </TouchableOpacity>
                        <Text style={{ height:26,lineHeight:26, fontFamily: 'fantasy', fontSize: 16, fontWeight:'700',color:'#101112' }}>347 Citations</Text>
                        <View style={{height:15}}></View>
                    </View>
                    <View style={{height:15}}></View>
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/7713905" }); this.setState({ display: true }) }}>
                            <Text style={{ height:60,lineHeight:30, fontFamily: 'fantasy', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Expression of antisense to DNA
                            demethylation and inhibits tumorigenesis. </Text>
                            <Text style={{ height:36,lineHeight:36, fontFamily: 'fantasy', fontSize: 14,color:'#626471'  }}>
                            J Biol Chem 1995 Apr 7</Text>
                        </TouchableOpacity>
                        <Text style={{ height:26,lineHeight:26, fontFamily: 'fantasy', fontSize: 16, fontWeight:'700',color:'#101112' }}>256 Citations</Text>
                        <View style={{height:15}}></View>
                    </View>
                    <View style={{height:15}}></View>
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/18851683" }); this.setState({ display: true }) }}>
                            <Text style={{ height:60,lineHeight:30, fontFamily: 'fantasy', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Epigenetics, DNA methylation,
                            and chromatin modifying drugs. </Text>
                            <Text style={{ height:36,lineHeight:36, fontFamily: 'fantasy', fontSize: 14,color:'#626471'  }}>
                            Annu Rev Pharmacol Toxicol. 2009;49</Text>
                        </TouchableOpacity>
                        <Text style={{ height:26,lineHeight:26, fontFamily: 'fantasy', fontSize: 16, fontWeight:'700',color:'#101112' }}>432 Citations</Text>
                        <View style={{height:15}}></View>
                    </View>
                    <View style={{height:15}}></View>
                    <View style={{ alignSelf: 'center', width: '90%',  alignSelf: 'center',borderBottomWidth:0.5,borderStyle:'solid' }}>
                        <TouchableOpacity  onPress={() => { this.setState({ url: "https://www.ncbi.nlm.nih.gov/pubmed/16484373" }); this.setState({ display: true }) }}>
                            <Text style={{ height:90,lineHeight:30, fontFamily: 'fantasy', fontSize: 14,fontWeight:'700',color:'#3B3B3B'  }}>Maternal care effects on the
                            hippocampal transcriptome and anxiety-mediated behaviors in the offspring that are reversible in adulthood. </Text>
                            <Text style={{ height:36,lineHeight:36, fontFamily: 'fantasy', fontSize: 14,color:'#626471'  }}>
                            Proc Natl</Text>
                        </TouchableOpacity>
                        <Text style={{ height:26,lineHeight:26, fontFamily: 'fantasy', fontSize: 16, fontWeight:'700',color:'#101112' }}>786 Citations</Text>
                        <View style={{height:15}}></View>
                    </View>
