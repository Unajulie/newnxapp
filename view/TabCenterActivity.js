        ...
        return (
            ...
            <View style={{flex:1}}>
                <ScrollView>
                    ...
                    <View>
                        <View style={{ backgroundColor: '#FBF0EC', height: px2dp(180), alignItems: 'center', }}>
                            <View style={{ height: px2dp(60), width: '100%', marginTop: px2dp(20), }}>
                                {this.state.user == null ?
                                    <Image style={{ height: '100%', width: '100%', borderRadius: px2dp(30) }} resizeMode="contain" source={require("../image/ic_unlogin.png")}></Image>
                                    :
