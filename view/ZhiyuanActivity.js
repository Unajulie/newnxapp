            ...
            <ScrollView>
                ...
                <View style={{ backgroundColor: '#0383DE' }}>
                    ...
                    <View style={{ backgroundColor: '#F0F0F0', borderTopLeftRadius: 20, borderTopRightRadius: 20 }}>
                        <View style={{ width: '90%', }}>
                            <Image style={{ height: 99, width: '100%', marginTop: -60, marginLeft: -60 }} resizeMode="contain" source={require("../image/icons/jason.png")}></Image>
                        </View>
                        <View style={{ borderTopLeftRadius: 20, borderTopRightRadius: 20 }}>
                            <View style={{ width: '90%', alignSelf: 'center', justifyContent: 'center', paddingTop: 20, paddingBottom: 20, borderStyle: "dashed", borderBottomWidth: 0.5 }}>
                                <Text style={{ fontSize: 18, lineHeight: 44, textAlign: 'left', marginLeft: 20, color: '#0071bc' }}>Zhiyuan Lv Ph.D.</Text>
                                <Text style={{ fontSize: 16, lineHeight: 18, textAlign: 'left', marginLeft: 20, }}>{I18n.t('ZhiyuanActivity.manager')}</Text>
                                <Text style={{ fontSize: 14, lineHeight: 18, textAlign: 'left', marginLeft: 20, fontStyle: 'italic' }}>{I18n.t('ZhiyuanActivity.beijing')}</Text>
                            </View>
                        </View>
                        {/* 个人经历 */}
                        {/* <View style={{ marginBottom: 20, backgroundColor: '#f0f0f0' }}>
                    <Text style={{ width: '90%', height: 67, alignSelf: 'center', fontFamily: 'fantasy', fontSize: 18, lineHeight: 67, fontWeight: 'bold' }}>{I18n.t('ZhiyuanActivity.professional')}</Text>
                </View>
                ...
                <View style={{ width: '100%', flexDirection: 'row' }} >
                    ...
                    <Text style={{ width: '70%', height: 16, lineHeight: 14, fontFamily: 'fantasy', paddingLeft: 10 }}>{I18n.t('ZhiyuanActivity.epidial')}</Text>
                </View>
                <View style={{ flexDirection: 'row', }}>
                    ...
                    <View style={{ width: '70%', height: 88, paddingLeft: 19 }} >
                        <Text style={{ lineHeight: 28, fontFamily: 'fantasy' }}>{I18n.t('ZhiyuanActivity.ltd')}</Text>
                        <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineHeight: 23, }}>{I18n.t('ZhiyuanActivity.lab')}</Text>
                    </View>
                </View>
                <View style={{ width: '100%', flexDirection: 'row' }} >
                    <Text style={{ width: '25%', height: 17, lineHeight: 19, fontFamily: 'fantasy', textAlign: 'center' }}>2012 –2015
                        </Text>
                    <Text style={{ alignSelf: 'flex-end', width: '5%', height: 18, backgroundColor: '#0071bc', borderRadius: 30, }}></Text>
                    <Text style={{ width: '70%', height: 16, lineHeight: 17, fontFamily: 'fantasy', paddingLeft: 10 }}>{I18n.t('ZhiyuanActivity.usa')}</Text>
                </View>
                <View style={{ flexDirection: 'row', }}>
                    ...
                    <View style={{ width: '70%', height: 68, paddingLeft: 19 }} >
                        <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineHeight: 34, }}>{I18n.t('ZhiyuanActivity.fellow')}</Text>
                    </View>
                </View>
                <View style={{ width: '100%', flexDirection: 'row' }} >
                    <Text style={{ width: '25%', height: 17, lineHeight: 19, fontFamily: 'fantasy', textAlign: 'center' }}>2010 – 2012
                        </Text>
                    <Text style={{ alignSelf: 'flex-end', width: '5%', height: 18, backgroundColor: '#0071bc', borderRadius: 30, }}></Text>
                    <Text style={{ width: '70%', height: 16, lineHeight: 17, fontFamily: 'fantasy', paddingLeft: 10 }}>{I18n.t('ZhiyuanActivity.state')}</Text>
                </View>
                <View style={{ flexDirection: 'row', }}>
                    <Text style={{ width: '28%', height: 68, fontFamily: 'fantasy', borderRightColor: '#e4d8d8', borderRightWidth: 1, textAlign: 'center' }}></Text>

                    <View style={{ width: '70%', height: 68, paddingLeft: 19 }} >
                        <Text style={{ lineHeight: 18, fontFamily: 'fantasy' }}>{I18n.t('ZhiyuanActivity.university')}</Text>
                        <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineHeight: 34, }}>{I18n.t('ZhiyuanActivity.phd')} </Text>
                    </View>
                </View>
                <View style={{ width: '100%', flexDirection: 'row' }} >
                    <Text style={{ width: '25%', height: 17, lineHeight: 19, fontFamily: 'fantasy', textAlign: 'center' }}>2006 - 2012
                        </Text>
                    <Text style={{ alignSelf: 'flex-end', width: '5%', height: 18, backgroundColor: '#0071bc', borderRadius: 30, }}></Text>
                    <Text style={{ width: '70%', height: 16, lineHeight: 17, fontFamily: 'fantasy', paddingLeft: 10 }}> {I18n.t('ZhiyuanActivity.key')}</Text>
                </View>
                <View style={{ flexDirection: 'row', }}>
                    <Text style={{ width: '28%', height: 68, fontFamily: 'fantasy', borderRightColor: '#e4d8d8', borderRightWidth: 1, textAlign: 'center' }}>
                    </Text>
                    <View style={{ width: '70%', height: 68, paddingLeft: 19 }} >
                        <Text style={{ lineHeight: 18, fontFamily: 'fantasy' }}>{I18n.t('ZhiyuanActivity.nanjing')}</Text>
                        <Text style={{ fontFamily: 'fantasy', color: '#0071bc', lineHeight: 45, }}>{I18n.t('ZhiyuanActivity.candidate')}</Text>
                    </View>
                </View> */}
