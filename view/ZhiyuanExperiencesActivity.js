    ...
    render() {
        ...
        return (
            <ScrollView>
                ...
                <View>
                    <Text style={{ width: '90%', height: 67, alignSelf: 'center', fontFamily: 'NotoSansHans-Light', fontSize: 28, lineHeight: 67, fontWeight: 'bold' }}>{I18n.t('ZhiyuanActivity.professional')}</Text>
                </View>
                <View style={{ marginTop: 20, marginBottom: 20 }}>
                      ...
                      <View style={{ width: '90%', justifyContent:'center',alignSelf:'center',borderWidth:1,borderRadius:15,borderColor:'#B2B2B2',paddingBottom:20,paddingTop:20 }} >
                        ...
                        <Text style={{  height: 20, lineHeight: 20, fontFamily: 'NotoSansHans-Light', paddingLeft: 10, textAlign: 'center',fontWeight:'700',fontSize:16  }}>{I18n.t('ZhiyuanActivity.epidial')}</Text>
                        <Text style={{ fontFamily: 'NotoSansHans-Light', color: '#676A74', lineHeight: 45,textAlign: 'center',fontSize:16  }}>{I18n.t('ZhiyuanActivity.ltd')}</Text>
                        <Text style={{ fontFamily: 'NotoSansHans-Light', color: '#676A74', lineHeight: 45,textAlign: 'center',fontSize:16  }}>{I18n.t('ZhiyuanActivity.lab')}</Text>
                    </View>
                    <View style={{ height: 20 }}></View>
                    {/* 2012 –2015 */}
                    <View style={{ width: '90%', justifyContent:'center',alignSelf:'center',borderWidth:1,borderRadius:15,borderColor:'#B2B2B2',paddingBottom:20,paddingTop:20 }} >
                        <Text style={{  height: 22, lineHeight: 22, fontFamily: 'NotoSansHans-Light', textAlign: 'center',fontSize:14 }}>2012 –2015</Text>  
                        <Text style={{  height: 20, lineHeight: 20, fontFamily: 'NotoSansHans-Light', paddingLeft: 10, textAlign: 'center',fontWeight:'700',fontSize:16  }}>{I18n.t('ZhiyuanActivity.usa')}</Text>
                        <Text style={{ fontFamily: 'NotoSansHans-Light', color: '#676A74', lineHeight: 45,textAlign: 'center',fontSize:16  }}>{I18n.t('ZhiyuanActivity.fellow')}</Text>
                    </View>
                    <View style={{ height: 20 }}></View>
                     {/* 2010 – 2012 */}
                     <View style={{ width: '90%', justifyContent:'center',alignSelf:'center',borderWidth:1,borderRadius:15,borderColor:'#B2B2B2',paddingBottom:20,paddingTop:20 }} >
                        <Text style={{  height: 22, lineHeight: 22, fontFamily: 'NotoSansHans-Light', textAlign: 'center',fontSize:14 }}>2010 – 2012</Text>  
                        <Text style={{  height: 20, lineHeight: 20, fontFamily: 'NotoSansHans-Light', paddingLeft: 10, textAlign: 'center',fontWeight:'700',fontSize:16  }}>{I18n.t('ZhiyuanActivity.state')}</Text>
                        <Text style={{ fontFamily: 'NotoSansHans-Light', color: '#676A74', lineHeight: 45,textAlign: 'center',fontSize:16  }}>{I18n.t('ZhiyuanActivity.university')}</Text>
                        <Text style={{ fontFamily: 'NotoSansHans-Light', color: '#676A74', lineHeight: 45,textAlign: 'center',fontSize:16  }}>{I18n.t('ZhiyuanActivity.phd')}</Text>
                    </View>
                    <View style={{ height: 20 }}></View>
                    {/* 2006 - 2012 */}
                    <View style={{ width: '90%', justifyContent:'center',alignSelf:'center',borderWidth:1,borderRadius:15,borderColor:'#B2B2B2',paddingBottom:20,paddingTop:20 }} >
                        <Text style={{  height: 22, lineHeight: 22, fontFamily: 'NotoSansHans-Light', textAlign: 'center',fontSize:14 }}>2010 – 2012</Text>  
                        <Text style={{  height: 20, lineHeight: 20, fontFamily: 'NotoSansHans-Light', paddingLeft: 10, textAlign: 'center',fontWeight:'700',fontSize:16  }}>{I18n.t('ZhiyuanActivity.key')}</Text>
                        <Text style={{ fontFamily: 'NotoSansHans-Light', color: '#676A74', lineHeight: 45,textAlign: 'center',fontSize:16  }}>{I18n.t('ZhiyuanActivity.nanjing')}</Text>
                        <Text style={{ fontFamily: 'NotoSansHans-Light', color: '#676A74', lineHeight: 45,textAlign: 'center',fontSize:16  }}>{I18n.t('ZhiyuanActivity.candidate')}</Text>
                    </View>
                    <View style={{ height: 20 }}></View>
