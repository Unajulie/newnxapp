    ...
    render() {
        ...
        return (
            <ScrollView>
                ...
                <View>
                    <Text style={{ width: '90%', height: 67, alignSelf: 'center', fontFamily: 'fantasy', fontSize: 28, lineHeight: 67, fontWeight: 'bold' }}>{I18n.t('ZhiyuanActivity.honors')}</Text>
                </View>
                ...
                <View style={{ marginTop: 20, marginBottom: 20 }}>
                    ...
                    <View style={{ width: '90%', justifyContent: 'center', alignSelf: 'center', borderWidth: 1, borderRadius: 15, borderColor: '#B2B2B2', paddingBottom: 20, paddingTop: 20 }} >
                        ...
                        <Text style={{ height: 40, lineHeight: 30, fontFamily: 'fantasy', textAlign: 'center', fontSize: 16 }}>{I18n.t('ZhiyuanActivity.american')}</Text>
                    </View>
                    ...
                    <View style={{ width: '90%', justifyContent: 'center', alignSelf: 'center', borderWidth: 1, borderRadius: 15, borderColor: '#B2B2B2', paddingBottom: 20, paddingTop: 20 }} >
                        ...
                        <Text style={{ height: 40, lineHeight: 30, fontFamily: 'fantasy', textAlign: 'center', fontSize: 16 }}>{I18n.t('ZhiyuanActivity.council')}</Text>
                    </View>
                    <View style={{ height: 20 }}></View>
                    <View style={{ width: '90%', justifyContent: 'center', alignSelf: 'center', borderWidth: 1, borderRadius: 15, borderColor: '#B2B2B2', paddingBottom: 20, paddingTop: 20 }} >
                        ...
                        <Text style={{ height: 30, lineHeight: 30, fontFamily: 'fantasy', textAlign: 'center', fontSize: 16 }}>{I18n.t('ZhiyuanActivity.biochemistry')}</Text>
                        <Text style={{ height: 30, lineHeight: 30, fontFamily: 'fantasy', textAlign: 'center', fontSize: 16 }}>{I18n.t('ZhiyuanActivity.annuals')}</Text>
                        <Text style={{ height: 30, lineHeight: 30, fontFamily: 'fantasy', textAlign: 'center', fontSize: 16 }}>{I18n.t('ZhiyuanActivity.cellular')}</Text>
                        <Text style={{ height: 30, lineHeight: 30, fontFamily: 'fantasy', textAlign: 'center', fontSize: 16 }}>{I18n.t('ZhiyuanActivity.journal')}</Text>
                    </View>
                    <View style={{ height: 20 }}></View>
                    <View style={{ width: '90%', justifyContent: 'center', alignSelf: 'center', borderWidth: 1, borderRadius: 15, borderColor: '#B2B2B2', paddingBottom: 20, paddingTop: 20 }} >
                        ...
                        <Text style={{ height: 40, lineHeight: 30, fontFamily: 'fantasy', textAlign: 'center', fontSize: 16 }}>{I18n.t('ZhiyuanActivity.journal')}</Text>
                    </View>
